...
export function BriefPanel({
  ...
  if (!article) {
    return (
      <div className="flex flex-col w-full lg:w-1/2 bg-white border-l border-[#C7D2E1]/30 p-6 items-center justify-center text-[#5AA6FF]">
  ...
  return (
    <div className="flex flex-col w-full max-w-full lg:w-1/2 liquid-glass-ultra lg:border-l border-[#C7D2E1]/30 lg:overflow-y-auto overflow-x-hidden animate-slideInRight">
      ...
      <div className="sticky top-0 liquid-glass-premium border-b border-[#C7D2E1]/30 p-4 sm:p-6 shadow-sm z-10 w-full max-w-full overflow-x-hidden">
        <h2 className="text-lg sm:text-xl font-bold text-[#0F172A] mb-3 leading-tight break-words">{article.title}</h2>
      ...
      <div className="flex-1 p-4 sm:p-6 space-y-6 lg:overflow-y-auto w-full max-w-full overflow-x-hidden">
        ...
        {article.bullets5 && article.bullets5.length > 0 && (
          <div className="space-y-4 p-5 liquid-glass-premium rounded-2xl border border-[#5AA6FF]/40 shadow-sm hover:shadow-md transition-all duration-300">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-[#0F172A] text-base">AI-Generated Summary</h3>
            </div>
            <ul className="space-y-3">
              {article.bullets5.map((bullet, idx) => (
                <li key={idx} className="flex gap-3 text-sm text-[#0F172A] leading-relaxed hover:text-[#0F172A] transition-colors duration-300 hover:translate-x-1">
                  <span className="font-bold text-[#5AA6FF] flex-shrink-0 mt-0.5">→</span>
