...
function MetricCard({ icon, label, value, color }: MetricCardProps) {
  const colorClasses = {
    blue: 'from-blue-50 to-purple-50 border-blue-200 text-blue-600',
  ...
  return (
    <div className={`liquid-glass rounded-xl border p-6 bg-gradient-to-br ${colorClasses[color]} hover:shadow-lg transition-all duration-300 animate-enhancedPremiumGlow`}>
      <div className="flex items-start justify-between mb-4">
        <div className={`p-3 rounded-lg bg-white/60 ${colorClasses[color].split(' ')[2]} animate-iconGlow shadow-md`}>
          {icon}
        </div>
      </div>
  ...
  return (
    <div className={`liquid-glass rounded-xl border p-6 bg-gradient-to-br ${colorClasses[color]} hover:shadow-lg transition-all duration-300 animate-enhancedPremiumGlow`}>
      <div className="flex items-center gap-3 mb-6">
        <div className="p-2 rounded-lg bg-white/60 animate-iconGlow shadow-md">
          {icon}
        </div>
