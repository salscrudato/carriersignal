...
export function InfiniteScrollLoader({
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center py-12 px-4">
        <div className="rounded-full liquid-glass-light p-3 mb-4 border border-red-200/30">
  ...
  if (isEmpty) {
    return (
      <div className="flex flex-col items-center justify-center py-12 px-4">
        <div className="rounded-full liquid-glass-premium p-3 mb-4 border border-blue-200/30">
  ...
  if (!hasMore && !isLoading) {
    return (
      <div className="flex flex-col items-center justify-center py-12 px-4">
        <div className="rounded-full liquid-glass-light p-3 mb-4 border border-slate-200/30">
...
function SkeletonCard({ delay = 0 }: { delay?: number }) {
  return (
    <div
      ...
      className="w-full max-w-full rounded-xl border-2 border-blue-200/30 overflow-hidden animate-slideInWithBounce liquid-glass"
    >
      {/* Gradient Accent Top */}
      ...
      <div className="p-4 space-y-3 flex-1 flex flex-col bg-gradient-to-br from-white via-blue-50/20 to-purple-50/10 w-full max-w-full overflow-x-hidden">
        ...
        {/* Summary Lines */}
        <div className="space-y-2 py-3 border-t border-blue-100 pt-3">
        ...
        {/* Buttons */}
        <div className="flex gap-2 pt-4 mt-auto border-t border-blue-100 pt-3">
