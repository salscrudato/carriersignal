    ...
    <div className="flex-1 overflow-y-auto">
      <div className="max-w-2xl mx-auto p-6 space-y-8">
        ...
        <div className="flex items-center gap-3 mb-8">
          <div className="w-10 h-10 rounded-lg liquid-glass-premium flex items-center justify-center border border-blue-200/40 animate-iconGlow">
                ...
                <button
                  ...
                  className={`w-full p-4 rounded-lg border-2 transition-all duration-200 text-left flex items-center gap-3 ${
                    selectedSort === sort.id
                      ? 'liquid-glass-premium border-blue-300/60 bg-gradient-to-r from-blue-50/40 to-purple-50/20'
                      : 'liquid-glass-light border-blue-200/40 hover:border-blue-300/60 hover:bg-gradient-to-r hover:from-blue-50/20 hover:to-purple-50/10'
                  }`}
                >
                  <div className="text-blue-600 animate-iconGlow">
        ...
        <div className="flex gap-3 pt-6 border-t border-blue-200/30">
          <button
            onClick={handleSave}
            className="flex-1 flex items-center justify-center gap-2 px-6 py-3 liquid-glass-premium text-blue-700 rounded-lg hover:border-blue-300/60 transition-all duration-300 font-semibold border border-blue-200/40 elevated-glow hover:shadow-lg"
          >
            <Save size={18} />
            Save Settings
          </button>
          {saved && (
            <div className="flex items-center gap-2 px-4 py-3 liquid-glass-light text-green-700 rounded-lg text-sm font-medium border border-green-200/40 animate-slideInRight">
              <Check size={18} />
              Saved
            </div>
          )}
